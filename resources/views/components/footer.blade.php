    ...
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 my-5 border-top">
        ...
        <div class="col mb-3 ">
            ...
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="/catalog" class="nav-link p-0 text-muted">Каталог</a></li>
                <li class="nav-item mb-2"><a href="/create-card" class="nav-link p-0 text-muted">Разместить своё
                        объявление</a></li>
            </ul>
        </div>
